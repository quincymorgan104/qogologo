...
def birthday(bday)
  ...
  if @bday >=120 && @bday <=218
    ...
    @zodiac="Virgo"
    @date="August 23rd to September 22nd"
    ...
    @zodiac="Libra"
    @date="September 23rd to October 22nd"
    ...
    @zodiac="Scorpio"
    @date="October 23rd to November 21st"
    ...
    @zodiac="Sagittarius"
    @date="November 22nd to December 21st"
